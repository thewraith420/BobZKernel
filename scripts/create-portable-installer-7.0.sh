#!/bin/bash
# Create portable kernel installer package for BobZKernel 7.0.
...
if [ ! -d "$KERNEL_DIR" ]; then
    echo -e "${RED}Error: $KERNEL_DIR not found. Run update-and-build-7.0.sh first.${NC}"
    exit 1
fi
...
#!/bin/bash
# BobZKernel 7.0 portable installer.
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║         BobZKernel 7.0 Portable Installer            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
echo
